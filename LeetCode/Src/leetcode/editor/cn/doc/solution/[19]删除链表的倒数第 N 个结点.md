...
print(remove_nth_from_end(ListNode.from_list([1, 2, 3, 4, 5]), 2).to_list())
print(remove_nth_from_end(ListNode.from_list([1]), 1))
print(remove_nth_from_end(ListNode.from_list([1, 2]), 1).to_list())
```
